# create by andy at 2022/3/29
# reference: https://github.com/aurora95/Keras-FCN/blob/master/models.py
import os
...
def FCN_Vgg16_32s(input_shape=None, weight_decay=0., batch_momentum=0.9, batch_shape=None, classes=21):
    ...
    x = pix2pix.upsample(512, 3)(x)
    x = pix2pix.upsample(512, 3)(x)
    x = pix2pix.upsample(5, 3)(x)
    model = Model(img_input, x)
    return model

if __name__ == '__main__':
    vgg = FCN_Vgg16_32s(input_shape=[224, 224, 3])
    vgg.summary()
